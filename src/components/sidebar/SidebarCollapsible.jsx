  ...
  setup(props, { slots }) {
    ...
    return () => (
      <div class="relative">
        ...
        <Transition onBeforeEnter={beforeEnter} onEnter={enter} onBeforeLeave={beforeLeave} onLeave={leave} appear>
          <div
            v-show={isOpen.value && (sidebarState.isOpen || sidebarState.isHovered)}
